...
//***************************************************************************************
  ...
  TH1D * _MinvS  = new TH1D("sig0","sig0",50,0,500);
  TH1D * _MinvB   = new TH1D("data_obs","data_obs",120,80,200);
//***************************************************************************************
  ...
  f->Write();
   mbbv.push_back(_MinvB->GetMean());
   mbbe.push_back(_MinvB->GetMeanError());
